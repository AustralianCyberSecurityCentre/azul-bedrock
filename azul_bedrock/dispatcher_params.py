...
class GetEvent(StrEnum):
    ...
    # Apply "D" to consumer groups generated by this request, which can subsequently be iterated over.
    Debug = "debug"
    # Reset the the offsets of consumer groups associated with this request
    Reset = "reset"
