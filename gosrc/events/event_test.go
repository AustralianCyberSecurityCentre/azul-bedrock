...
import (
	...
	"github.com/AustralianCyberSecurityCentre/azul-bedrock/v11/gosrc/testdata"
...
func TestBinaryEvent2(t *testing.T) {
	...
	verifyEncodeDecodeBinaryEvent(t,
		...
		&BinaryEvent{
			...
			TrackLinks:            []string{"parent.child.0001_01_01T00_00_00Z_00..apple."},
			TrackAuthors:          []string{".apple.", ".apple."},
		},
		`{
			"track_source_references":"source.5febce412be5ba9ce929ff9ad16bdd50",
			"track_links":["parent.child.0001_01_01T00_00_00Z_00..apple."],
